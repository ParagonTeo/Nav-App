...
const DiningOptions = () => {
  return (
    <Layout>
      <Box display="flex" flexDirection={'column'} justifyContent="center" width="100vw" height="100vh" alignItems={"center"} alignContent={"center"}>
        <Box bgcolor="white" style={{ marginTop: 16, marginLeft: 46, marginRight: 46 }}>
          <Box >
